...
\subsection{Final Dataset}
	...
	\begin{table}[htbp]
		...
		\begin{threeparttable}
			...
			\end{small}
			\begin{tablenotes}
				\item \footnotesize\textit{Note:} Income classifications sourced from the World Bank Atlas method. These are modal classifications across all years for which it appears in the historical files. The classification thus represents the income group in which a country spent the largest number of years over the entire 1987--2024 period.
			\end{tablenotes}
		\end{threeparttable}
